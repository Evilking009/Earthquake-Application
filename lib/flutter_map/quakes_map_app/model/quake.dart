...
class Properties {
  ...
  Properties.fromJson(Map<String, dynamic> json) {
    mag = TypesHelper.to_double(json['mag']);
    place = json['place'];
    time = TypesHelper.to_int(json['time']);
    updated = TypesHelper.to_int(json['updated']);
    url = json['url'];
    detail = json['detail'];
    status = json['status'];
    tsunami = TypesHelper.to_int(json['tsunami']);
    sig = TypesHelper.to_int(json['sig']);
    net = json['net'];
    code = json['code'];
    ids = json['ids'];
    sources = json['sources'];
    types = json['types'];
    rms = TypesHelper.to_double(json['rms']);
